...
echo ""
echo "To upgrade nDPI: bump NDPI_VERSION in backend/Dockerfile, re-run this script,"
echo "transfer images/tracepcap-backend.tar to the offline machine, and load-images.sh."
